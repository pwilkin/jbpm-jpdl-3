...
public class JbpmConfigurationTest extends AbstractJbpmTestCase {
  ...
  {
    super.setUp();
    JbpmConfiguration.instances = new HashMap<String, JbpmConfiguration>();
    JbpmConfiguration.defaultObjectFactory = null;
    JbpmConfiguration.jbpmConfigurationsStacks =  new ThreadLocal<Stack<JbpmConfiguration>>();
    JbpmContext.currentContextsStack = new ThreadLocal<Stack<JbpmContext>>();
  }
